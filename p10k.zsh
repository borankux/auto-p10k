# Generated by Powerlevel10k configuration wizard on 2025-11-02 at 01:11 CST.
...
() {
  ...
  function prompt_server_name() {
  # Per-host metadata file
  local META_FILE="$HOME/.p10k-meta"

  # Default label if not configured
  local LABEL=""

  # If ~/.p10k-meta exists and defines SERVER_NAME, use that instead
  if [[ -f "$META_FILE" ]]; then
    # load SERVER_NAME="..."
  ...
  # Draw the badge segment with same bg/fg as OS icon
  p10k segment \
